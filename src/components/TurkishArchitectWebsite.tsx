...
const TurkishArchitectWebsite: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="musteri-gorusleri" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900">Müşteri Görüşleri</h2>
            <p className="text-lg text-gray-600 mt-4">Bizimle çalışan müşterilerimiz ne diyor?</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
